...
class NativeImageCropperWeb extends NativeImageCropperPlatform {
  final MethodChannel _methodChannel =
      const MethodChannel('biz.cosee/native_image_cropper_web');

  /// Registers this class as the default instance
  /// of [NativeImageCropperPlatform].
  static void registerWith() =>
      NativeImageCropperPlatform.instance = NativeImageCropperWeb();
